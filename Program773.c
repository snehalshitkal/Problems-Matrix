/*
    ...
    Description :   Accept number of rows and columns from user 
                    Display the Summetion of Even Row in  matrix.
...
int SummetionEvenRow(IPPTR Arr,int iRow,int iCol)       //O(N^N/2)
{
    int i = 0,j = 0, iSum = 0;
...
int main()
{
    ...
    for(i = 0;i<iRow;i++)
    {
        ...
        int iRet = SummetionEvenRow(Arr,iRow,iCol);
        printf("Summetion of Even Row : %d",iRet);
